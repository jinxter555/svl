  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_FLT = 18,                              // FLT
        S_STR = 19,                              // STR
        S_REGISTER = 20,                         // REGISTER
        S_CALL = 21,                             // CALL
        S_LOAD_L = 22,                           // LOAD_L
        S_STORE_L = 23,                          // STORE_L
        S_ASSIGN = 24,                           // ASSIGN
        S_PLUS = 25,                             // PLUS
        S_MINUS = 26,                            // MINUS
        ...
        S_MODULO = 29,                           // MODULO
        S_UMINUS = 30,                           // UMINUS
        S_FACTORIAL = 31,                        // FACTORIAL
        S_EXPONENT = 32,                         // EXPONENT
        S_YYACCEPT = 33,                         // $accept
        S_lines = 34,                            // lines
        S_line = 35,                             // line
        S_super_instruction = 36,                // super_instruction
        S_directive = 37,                        // directive
        S_DOTSTR = 38,                           // DOTSTR
