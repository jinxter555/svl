...
Node::OpStatus LispExpr::var_attach(Node&process, const Node::Vector& var_list, size_t start)  {
  ...
  MYLOGGER_MSG(trace_function, "var_list: " + Node::_to_str(var_list), SLOG_FUNC_INFO+30)
  ...
  return var_attach_scope(process, scope_vars_status.second, var_list, "", start);
  /*
...
//------------------------------------------------------------------------
Node::OpStatus LispExpr::var_attach_scope(Node&process, Node&scope_var, const Node::Vector& var_list, const string& mod_name, size_t start)  {
  MYLOGGER(trace_function, "LispExpr::var_attach_scope(process, scope_var, var_list)", __func__, SLOG_FUNC_INFO);
