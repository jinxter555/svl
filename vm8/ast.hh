...
public:
  ...
  virtual astexpr_u_ptr clone() const =0; 
  virtual Operand clone_val() const=0;
  //-------------------------------------------
  virtual astexpr_u_ptr& operator[] (const Operand& k) =0;
  virtual const astexpr_u_ptr& operator[] (const Operand &k) const =0;
  ...
  virtual vector<string> _get_keys() =0;
  //-------------------------------------------
  virtual Operand opfunc(const Operand& other, AstOpCode op) =0;
  //-------------------------------------------
