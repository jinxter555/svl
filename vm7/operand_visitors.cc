...
OperandType GetOperandType::operator()(const astexpr_ptr v) const { return OperandType::ptr_t;}
OperandType GetOperandType::operator()(const astexpr_s_ptr& v) const { return OperandType::sptr_t;}
